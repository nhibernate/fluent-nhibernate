...
namespace FluentNHibernate.Specs.FluentInterface.ClassMapSpecs
{
    ...
    {
        Because of = () =>
            mapping = map_as_class<EntityWithComponent>(m => m.Component(Reveal.Property<EntityWithComponent>("Component"), c => { }));
    ...
    {
        Because of = () =>
            mapping = map_as_class<EntityWithComponent>(m => m.DynamicComponent(Reveal.Property<EntityWithComponent, IDictionary>("DynamicComponent"), c => { }));
    ...
    {
        Because of = () =>
            mapping = map_as_class<EntityWithComponent>(m => m.Component(Reveal.Property<EntityWithComponent>("Component")));
