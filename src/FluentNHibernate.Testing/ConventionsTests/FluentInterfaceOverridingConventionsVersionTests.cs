...
{
    [TestFixture]
    public class FluentInterfaceOverridingConventionsVersionTests
    {
        ...
        {
            Mapping<ValidVersionClass>(x => x.Version, x => x.Access.AsField());
        ...
        {
            Mapping<ValidVersionClass>(x => x.Version, x => x.ColumnName("name"));
