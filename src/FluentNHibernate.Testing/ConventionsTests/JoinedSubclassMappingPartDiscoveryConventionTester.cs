...
{
    [TestFixture]
    public class JoinedSubclassMappingPartDiscoveryConventionTester
    {
        private JoinedSubclassMappingPartDiscoveryConvention convention;
        ...
        public void CreateConvention()
        {
            ...
            convention = new JoinedSubclassMappingPartDiscoveryConvention(conventionFinder);
        }

        [Test]
        public void ApplyFindsConventions()
        {
            var cm = MockRepository.GenerateStub<IJoinedSubclass>();
