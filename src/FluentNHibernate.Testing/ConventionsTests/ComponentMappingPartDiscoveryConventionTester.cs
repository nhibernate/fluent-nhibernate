...
{
    [TestFixture]
    public class ComponentMappingPartDiscoveryConventionTester
    {
        private ComponentMappingPartDiscoveryConvention convention;
        ...
        public void CreateConvention()
        {
            ...
            convention = new ComponentMappingPartDiscoveryConvention(conventionFinder);
        }

        [Test]
        public void ApplyFindsConventions()
        {
            var cm = MockRepository.GenerateStub<IComponent>();
