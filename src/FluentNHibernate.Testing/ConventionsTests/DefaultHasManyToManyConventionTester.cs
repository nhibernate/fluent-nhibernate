...
{
    [TestFixture]
    public class DefaultHasManyToManyConventionTester
    {
        private DefaultHasManyToManyConvention convention;
        ...
        public void CreateConvention()
        {
            ...
            convention = new DefaultHasManyToManyConvention(conventionFinder);
        }
