...
{
    [TestFixture]
    public class SubclassMappingPartDiscoveryConventionTester
    {
        private SubclassMappingPartDiscoveryConvention convention;
        ...
        public void CreateConvention()
        {
            ...
            convention = new SubclassMappingPartDiscoveryConvention(conventionFinder);
        }

        [Test]
        public void ApplyFindsConventions()
        {
            var cm = MockRepository.GenerateStub<ISubclass>();
