...
namespace FluentNHibernate.Testing.Cfg
{
	...
	public class PersistenceConfigurationTester
	{
	    ...
	    {
			_config.Cache.ProviderClass("foo");
	    ...
	    {
			_config.Cache.QueryCacheFactory("foo");
	    ...
	    {
	        _config.Cache.RegionPrefix("foo");
