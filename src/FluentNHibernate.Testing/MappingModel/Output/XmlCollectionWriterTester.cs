...
namespace FluentNHibernate.Testing.MappingModel.Output
{
    ...
    public class XmlCollectionWriterTester
    {
        ...
        public void ShouldWriteBagForBagMapping()
        {
            ...
            writer = new XmlCollectionWriter(new XmlBagWriter(null, null), null, null);
        ...
        public void ShouldWriteListForListMapping()
        {
            ...
            writer = new XmlCollectionWriter(null, null, new XmlListWriter(null, null));
            writer.VerifyXml(mapping)
        ...
        public void ShouldWriteSetForSetMapping()
        {
            ...
            writer = new XmlCollectionWriter(null, new XmlSetWriter(null, null), null);
            writer.VerifyXml(mapping)
        ...
        public void ShouldWriteMapForMapMapping()
        {
            ...
            writer = new XmlCollectionWriter(null, null, null);
            writer.VerifyXml(mapping)
