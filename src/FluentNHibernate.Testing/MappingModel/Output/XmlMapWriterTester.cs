...
namespace FluentNHibernate.Testing.MappingModel.Output
{
    ...
    public class XmlMapWriterTester
    {
        ...
        {
            writer = new XmlMapWriter(null, null);
        ...
        public void ShouldWriteKey()
        {
            ...
            writer = new XmlMapWriter(new XmlKeyWriter(null), null);
        ...
        public void ShouldWriteRelationshipElement()
        {
            ...
            writer = new XmlMapWriter(null, new XmlCollectionRelationshipWriter(new XmlOneToManyWriter(), null));
            writer.VerifyXml(mapping)
