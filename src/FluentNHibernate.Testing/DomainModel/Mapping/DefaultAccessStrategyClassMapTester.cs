    ...
    public class DefaultAccessStrategyClassMapTester
    {
        ...
        public void AccessAsProperty_SetsAccessStrategyToProperty()
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsProperty())
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsField())
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsCamelCaseField())
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsCamelCaseField(Prefix.Underscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsLowerCaseField())
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsLowerCaseField(Prefix.Underscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsPascalCaseField(Prefix.Underscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsPascalCaseField(Prefix.m))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsPascalCaseField(Prefix.mUnderscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughCamelCaseField())
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughCamelCaseField(Prefix.Underscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughLowerCaseField())
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughLowerCaseField(Prefix.Underscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughPascalCaseField(Prefix.Underscore))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughPascalCaseField(Prefix.m))
        ...
        {
            new MappingTester<PropertyTarget>()
                .ForMapping(c => c.HibernateMapping.DefaultAccess.AsReadOnlyPropertyThroughPascalCaseField(Prefix.mUnderscore))
